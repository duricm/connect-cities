 ...
 */
class CognitoAuthenticationHelper {
    ...
    CognitoAuthenticationHelper(String userPoolID, String clientid, String secretKey, String region) {
        do {
...
/*
        try {
            ...
            this.region = "us-east-2"; // prop.getProperty("REGION");
    ...
    String PerformSRPAuthentication(String username, String password) {
        ...
        try {
            ...
            LOGGER.info("Failed to validate user credentials. Cognito error is: " + ex);
            throw new UnauthorizedException("Failed to validate user credentials for user: " + username);
    ...
    private InitiateAuthRequest initiateUserSrpAuthRequest(String username) {
        ...
        //initiateAuthRequest.addAuthParametersEntry("SECRET_HASH", "v7kngf2jjo3gta81ojov6l5s54s98am4ho9h909aoghm3g2udnj");
    ...
    private RespondToAuthChallengeRequest userSrpAuthRequest(InitiateAuthResult challenge,
        ...
        if (B.mod(CognitoAuthenticationHelper.N).equals(BigInteger.ZERO)) {
    ...
    private String calculateSecretHash(String userPoolClientId, String userPoolClientSecret, String userName) {
    	...
    	System.out.println("Client is: " + userPoolClientId);
    	System.out.println("User Name is" + userName);
    	System.out.println("secret key is" + userPoolClientSecret);
